...
| 2 | Asesor Estratégico | `01_DIRECCION/` | ACTIVO | OKRs, decisiones estratégicas, visión | 2026-04-12 |
...
| 9 | Inteligencia de Mercado | `02_COMERCIAL/` (lectura) | ACTIVO | Licitaciones, CORFO/ANID, prospección sectorial | 2026-04-12 |
| 10 | Revisora Técnica / QA | `03_PROYECTOS/` (revisión) | ACTIVO | Validación científica de entregables antes de entrega | 2026-04-12 |
| 11 | Dir. Alianzas y Transferencia | `01_DIRECCION/` | ACTIVO | Universidad–industria, talento, IP, alianzas externas | 2026-04-12 |
...
| Asistente Técnico de Ingeniería | Rodrigo | `00_SISTEMA/agentes/tecnico.md` |
| Asesor Estratégico | Isabel | `00_SISTEMA/agentes/estrategia.md` |
| Inteligencia de Mercado | Tomás | `00_SISTEMA/agentes/inteligencia.md` |
| Revisora Técnica / QA | Camila | `00_SISTEMA/agentes/qa.md` |
| Dir. Alianzas y Transferencia | Andrés | `00_SISTEMA/agentes/alianzas.md` |
...
- **Métodos en I+D / tesis:** No gestionar como IP ni ofrecer comercialmente hasta que estén documentados y validados en `06_CONOCIMIENTO/metodologias/`
- *Última actualización: 2026-04-12*
